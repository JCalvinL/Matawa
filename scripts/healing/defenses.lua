...
--Priest: Thanatology
def_deathsight = {defense = "deathsight", type = "normal", effect = "See location of death when people die", skill = "Deathsight", balance = {needybalancetake = "deathcall deathsight"}, state = "down", needit = false, timer = createStopWatch()},
...
def_sanguine_aspect = {defense = "sanguine aspect", type = "normal", effect = "Fueling faith with blood", skill = "Sanguine Aspect", balance = {}, state = "down", needit = false, timer = createStopWatch()},
--Priest: Crusading
